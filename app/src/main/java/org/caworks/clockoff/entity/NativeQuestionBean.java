...
/**
 * 本地问答数据库 bean
 * Created by gallon on 2017/4/20
 */

@Entity(nameInDb = "NativeQuestion")
public class NativeQuestionBean {
    ...
    public NativeQuestionBean(Long id, String answer, String question,

...
/** 
 * DAO for table "CLOCK_OFF_BEAN".
*/
public class ClockOffBeanDao extends AbstractDao<ClockOffBean, Long> {

    public static final String TABLENAME = "CLOCK_OFF_BEAN";
    ...
    public static class Properties {
        ...
        public final static Property Complete = new Property(7, int.class, "complete", false, "COMPLETE");
        public final static Property Repair = new Property(8, int.class, "repair", false, "REPAIR");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CLOCK_OFF_BEAN\" (" + //
                ...
                "\"REPAIR\" INTEGER NOT NULL );"); // 8: repair
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CLOCK_OFF_BEAN\"";
        db.execSQL(sql);
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, ClockOffBean entity) {
        ...
        stmt.bindLong(8, entity.getComplete());
        stmt.bindLong(9, entity.getRepair());
    }
    ...
    public ClockOffBean readEntity(Cursor cursor, int offset) {
        ClockOffBean entity = new ClockOffBean( //
            ...
            cursor.getInt(offset + 7), // complete
            cursor.getInt(offset + 8) // repair
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ClockOffBean entity, int offset) {
        ...
        entity.setComplete(cursor.getInt(offset + 7));
        entity.setRepair(cursor.getInt(offset + 8));
     }
